...
# strings that may be malformed for TOML
safe_string = st.text(min_size=0, max_size=20)
bad_string = st.text(
    min_size=1,
    max_size=10,
    alphabet=st.sampled_from(['"', '\\', '\n', '\r', '\t', '\b'])
)
string_leaf = st.one_of(safe_string, bad_string)
...
# ---------- DottedKey ----------
# Assume DottedKey class is available in the environment
