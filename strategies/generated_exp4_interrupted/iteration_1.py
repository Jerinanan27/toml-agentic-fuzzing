...
# malformed tokens – kept for occasional coverage
...
raw_valid = st.one_of(
    valid_int, valid_float, valid_bool, valid_string, valid_datetime
)

raw_malformed = st.one_of(
    malformed_int, malformed_float, malformed_string, malformed_datetime
)
...
shallow_value = st.one_of(
    raw_valid, raw_valid, raw_valid,  # bias toward valid scalars
    array_shallow,
    array_shallow,
